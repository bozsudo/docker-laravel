...
- $ /src > php artisan jetstream:install inertia
- $ /src > npx laravel-jetstream-react@latest install   [Replaces the vue components in a fresh jetstream application with their react equivalents.]
- $ /src > cd ../
...
- $ docker-compose run --publish 5173:5173 npm run dev
- $ docker-compose run --rm artisan serve
- $ docker-compose down

## Changing docker-compose file and restarting
- $ docker-compose ps
